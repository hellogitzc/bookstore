...
XIAOMI.checkOut = {
    ...
    baoxian: function() {
        ...
        function() {
            ...
            c ? (g.delProduct(d), $(this).removeClass("selected").find("input").prop("checked", !1), $(".J_baoxian_agree").find(".icon-checkbox").removeClass("icon-checkbox-checked"), !1) : void $("#baoxian").modal({
                backdrop: "static",
                show: !0
            }).on("hide.bs.modal",
            function() {
...
XIAOMI.checkOut.newAddr = {
    ...
    init: function() {
        ...
        $("#Provinces").change(function() {
            var b = $(this).val();
            "0" !== b ? (a.getRegionsData(b, "Citys"), a.newProvince = $(this).find("option:selected").html()) : (a.newProvince = null, a.newCity = null, a.newCounty = null),
    ...
    validation: function(a) {
        ...
        v = !1;
        if (t === u && (t = ""), !(b.strLen(t) >= 4)) return c.focus(),
        b.setMsg(c, "收货人姓名 太短 (最小值为 2 个中文字)"),
        !1;
        if (!q.test(t)) return c.focus(),
        ...
        var w = $.trim(i.val()),
        x = !1;
        if (a && w && w !== i.attr("placeholder") ? a = !1 : !a && w && w === i.attr("placeholder") ? i.attr("placeholder", "") : a || w || i.attr("placeholder", "11位手机号"), !a && w !== i.attr("placeholder") && !m.test(w)) return i.focus(),
        ...
        A = f.val(),
        B = !1;
        if (! (k.test(y) && k.test(z) && k.test(A))) return b.setMsg(d, "收货地址不正确"),
        !1;
        b.setMsg(d, ""),
        r.province = y,
        r.city = z,
        ...
        E = !1;
        if (C === D && (C = ""), !(C.length >= 5 && C.length <= 32)) return g.focus(),
        b.setMsg(g, "详细地址长度不对，最小为 5 个字，最大32个字"),
        !1;
        if (n.test(C) || o.test(C) || p.test(C)) return g.focus(),
        b.setMsg(g, "详细地址不正确"),
        !1;
        b.setMsg(g, ""),
        r.street = C,
        ...
        J = !1;
        if (H === I && (H = ""), H.length > 5) return j.focus(),
    ...
    editAddr: function(a) {
        ...
        a.tel ? (b.attr("data-tel", a.tel), b.find(".itemTel").html(a.tel)) : b.find(".itemTel").html(a.telPlaceholder),
